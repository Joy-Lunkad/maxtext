...
class LlamaDecoderLayer(nn.Module):
  ...
  def __call__(
    ...
    prefill_key_axis_order = [int(i) for i in cfg.prefill_key_axis_order.split(",")]
    prefill_value_axis_order = [int(i) for i in cfg.prefill_value_axis_order.split(",")]
    ar_key_axis_order = [int(i) for i in cfg.ar_key_axis_order.split(",")]
    ar_value_axis_order = [int(i) for i in cfg.ar_value_axis_order.split(",")]
    ...
    if cfg.key_value_axis_order_product_id != "":
      ...
      ar_key_axis_order = [int(i) for i in ar_key_axis_order_str.split(",")]
      ar_value_axis_order = [int(i) for i in ar_value_axis_order_str.split(",")]
