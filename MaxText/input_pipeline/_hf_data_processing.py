...
def preprocess_dataset(
  ...
  dataset = dataset.map(
      _hf_operations.tokenization,
      batched=True,
      fn_kwargs={"tokenizer": tokenizer, "max_length": config.max_target_length - 1},
  )
  dataset = dataset.select_columns(["input_ids"])

  dataset = _hf_operations.HFDataSource(dataset, dataloading_host_index, dataloading_host_count, num_threads)

  operations = []
  operations.append(_hf_operations.HFNormalizeFeatures())
